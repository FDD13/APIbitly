...
def main():
    ...
    parser = argparse.ArgumentParser(description='Обработка введенных в консоль ссылок')
    parser.add_argument('user_urls', nargs='+', help='Введенные ссылки')
    args = parser.parse_args()

    for user_url in args.user_urls:
        try:
